    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MeiziApp.sCx.getExternalCacheDir() != null)
                sDefaultDir = MeiziApp.sCx.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = MeiziApp.sCx.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
